...
if __name__ == "__main__":
    ...
    fis = fuzzy("Cartpole-controller", 2, 2, 2 ,2)
    ...
    rules =["If Theta is Negative And Theta_dot is Positive Then Force is PM and Torque is NM",
            "If Theta is Positive And Theta_dot is Not Negative Then Force is NM and Torque is PM"]
